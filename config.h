...
static MAYBE_CONST char normbgcolor[]           = "#1a1a1a"; // Matches Kitty
static MAYBE_CONST char normbordercolor[]       = "#1a1a1a";
static MAYBE_CONST char normfgcolor[]           = "#a0a0a0"; // Muted text
static MAYBE_CONST char selfgcolor[]            = "#ffffff"; // Snowy White
static MAYBE_CONST char selbordercolor[]        = "#ffffff";
static MAYBE_CONST char selbgcolor[]            = "#404040"; // Focus indicator
